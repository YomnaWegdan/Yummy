...
export default function Sidebar() {
  ...
  return (
    <>
    <div className={`w-80 py-3 position-fixed d-flex flex-column align-items-center justify-content-between text-black vh-100 bg-light  ${isOpen?'start-250':'start-0'}`}>
