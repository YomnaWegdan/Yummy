...
export default function Sidebar() {
  return (
    <div >
    <div className=' d-flex  flex-column align-items-center  justify-content-between  text-light'>
  ...
  <header class="vh-100 text-white" >
        <div class="overlay h-100">  
            <div class="sidebar position-fixed  left-0 d-flex h-100 z-3"></div>
