...
export default function Sidebar({ isSidebarOpen, toggleSidebar }) {
  return (
    <>
    <button onClick={toggleSidebar} className='btn btn-danger'>kkkkkkk</button>
      ...
      >
        ...
        <button onClick={toggleSidebar} className='btn btn-danger align-self-center mb-3'>kkkkkkk</button>
