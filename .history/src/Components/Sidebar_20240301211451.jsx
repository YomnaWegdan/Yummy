...
import { FaBars, FaTimes , FaGlobe , FaShareNodes} from 'react-icons/fa';
...
export default function Sidebar() {
  ...
  return (
    <>
    <div className={`side position-fixed d-flex flex-column align-items-center justify-content-between vh-100 bg-black  ${isOpen?'start-250':'start-0'}`}>
