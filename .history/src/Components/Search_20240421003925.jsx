            ...
            <div className="row min-vh-100">
                <div className="col-lg-6 col-md-12 mt-5">
                    <input placeholder="Search By Name" className="form-control" 
                        value={nameQuery}  onChange={handleNameInputChange} onInput={()=>refetchSearchLetter}/>
                </div>
                <div className="col-lg-6 col-md-12 mt-5">
                    <input placeholder="Search By First Letter" className="form-control" 
                        value={letterQuery}    onChange={handleLetterInputChange} onInput={()=>refetchSearchLetter}/>
                </div>                         
