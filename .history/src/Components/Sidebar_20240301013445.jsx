...
export default function Sidebar({ isSidebarOpen, toggleSidebar }) {
  return (
    <>
      ...
      >
      <button onClick={toggleSidebar} className='d-flex align-items-center'><FaBarsStaggered /></button>
  ...
  return (
    <Fragment>
      <div className='bg-dark'>
        {/* Pass toggleSidebar function to Sidebar */}
...
export default function Sidebar({ isSidebarOpen, toggleSidebar }) {
  return (
    ...
    >
      ...
      <button onClick={toggleSidebar} className='d-flex align-items-center'>Toggle Sidebar</button>
