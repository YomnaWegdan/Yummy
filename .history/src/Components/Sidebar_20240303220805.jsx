        ...
        <div className="sidebar-content">
          <div className="d-flex flex-column justify-content-between align-items-center vh-100 py-4">
            <ul className=' list-unstyled '>
              ...
              <li className="nav-item">
                <NavLink className="nav-link" href="/categories">Categories</NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" href="/area">Area</NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" href="/ingredients">Ingredients</NavLink>
              </li>
              <li className="nav-item">
