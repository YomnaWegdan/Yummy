...
export default function Sidebar() {
  ...
  return (
    <>
    <div className={`toggle-btn position-fixed top-50  ${isOpen?'start-250':'start-20'}`}>
    <button className={`toggle-btn position-fixed top-50  ${isOpen?'start-250':'start-20'}`} onClick={toggleSidebar}>
