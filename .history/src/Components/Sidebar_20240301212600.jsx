...
export default function Sidebar() {
  ...
  return (
    <>
    <div className={`side w-80 py-3 position-fixed d-flex flex-column align-items-center justify-content-between text-black vh-100 bg-light  ${isOpen?'start-250':'start-0'}`}>
  ...
  <div className='d-flex flex-column '><FaGlobe /> <FaShareNodes />
      ...
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        <div className="sidebar-content">
          <div className="d-flex flex-column justify-content-between align-it h-100">
